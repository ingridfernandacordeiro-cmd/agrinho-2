...
// Banco de dados expandido com factos reais sobre sustentabilidade e o programa
const dicas = [
...
function mostrarDicaAleatoria() {
    ...
    if (elementoTexto) {
        // Altera o conteúdo sem recarregar a página e sem travar o navegador com alertas
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Associa o clique do botão da página principal à função de sorteio
